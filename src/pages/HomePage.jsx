        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              {/* Primary & Secondary CTAs — Clean Standard Healthcare Buttons */}
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3">
                <Link
                  to="/refill"
                  className="w-full sm:w-auto px-6 py-3 rounded-md text-sm font-semibold text-white bg-[#092E96] hover:bg-[#061F69] shadow-xs transition-colors duration-150 flex items-center justify-center gap-2"
                >
                ...
                <Link
                  to="/contact"
                  className="w-full sm:w-auto px-6 py-3 rounded-md text-sm font-semibold text-slate-800 bg-white hover:bg-slate-50 border border-slate-300 shadow-xs transition-colors duration-150 flex items-center justify-center gap-2"
                >
                  <Phone className="w-4 h-4 text-[#092E96]" />
                  <span>Contact Our Pharmacists</span>
                </Link>
              </div>
      ...
      <section className="relative z-20 max-w-7xl mx-auto px-4 sm:px-8 -mt-6">
        <div className="bg-white rounded-xl border border-slate-200 shadow-md p-6 lg:p-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col sm:flex-row items-center justify-end gap-3">
              <Link
                to="/refill"
                className="w-full sm:w-auto px-6 py-3 rounded-md text-sm font-semibold text-white bg-[#092E96] hover:bg-[#061F69] shadow-xs transition-colors duration-150 flex items-center justify-center gap-2"
              >
                <span>Start Online Transfer Request</span>
                <ArrowRight className="w-4 h-4" />
              </Link>
              <a
                href="tel:+16123543851"
                className="w-full sm:w-auto px-5 py-3 rounded-md text-sm font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-200 transition-colors flex items-center justify-center gap-2"
              >
                <Phone className="w-4 h-4 text-[#092E96]" />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {servicesList.map((service) => {
              ...
              return (
                <div
                  key={service.id}
                  className={`bg-white rounded-2xl border transition-all duration-200 flex flex-col justify-between overflow-hidden group hover:-translate-y-1 hover:shadow-lg ${
                    service.isPrimary
                ...
                >
                  ...
                  <div className="p-6 sm:p-7 pt-0">
                    <Link
                      ...
                      className={`w-full py-2.5 px-4 rounded-lg text-xs font-bold transition-all duration-150 flex items-center justify-center gap-2 ${
                        service.isPrimary
                          ? 'bg-[#092E96] hover:bg-[#061F69] text-white shadow-xs'
                          : 'bg-slate-50 hover:bg-blue-50 text-slate-800 hover:text-[#092E96] border border-slate-200 hover:border-blue-200'
                      }`}
                    >
          ...
          <div className="mt-12 bg-white rounded-2xl border border-slate-200/90 shadow-sm p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3 shrink-0">
              <a
                href="tel:+16123543851"
                className="px-5 py-2.5 rounded-lg text-xs font-bold text-white bg-[#092E96] hover:bg-[#061F69] shadow-xs transition-colors flex items-center gap-2"
              >
              ...
              <Link
                to="/contact"
                className="px-5 py-2.5 rounded-lg text-xs font-bold text-slate-800 bg-white hover:bg-slate-50 border border-slate-300 shadow-xs transition-colors"
              >
            ...
            <div className="lg:col-span-7 p-8 lg:p-10 space-y-6">
              ...
              <div className="pt-2 flex flex-wrap gap-4">
                <a
                  ...
                  className="px-5 py-2.5 rounded-md text-xs font-semibold text-white bg-[#092E96] hover:bg-[#061F69] transition-colors duration-150 inline-flex items-center gap-2 shadow-xs"
                >
                ...
                <Link
                  to="/contact"
                  className="px-5 py-2.5 rounded-md text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-colors duration-150 inline-flex items-center gap-2"
                >
      ...
      <section className="py-14 max-w-7xl mx-auto px-4 sm:px-8">
        <div className="bg-gradient-to-br from-[#092E96] to-[#061F69] rounded-2xl p-8 sm:p-12 text-white text-center shadow-lg space-y-6">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/refill"
              className="w-full sm:w-auto px-7 py-3 rounded-md text-sm font-semibold text-[#092E96] bg-white hover:bg-slate-100 transition-colors duration-150 shadow-xs flex items-center justify-center gap-2"
            >
              <Pill className="w-4 h-4 text-[#092E96]" />
              <span>Transfer Prescription Now</span>
            </Link>
            <Link
              to="/contact"
              className="w-full sm:w-auto px-7 py-3 rounded-md text-sm font-semibold text-white bg-[#061F69] hover:bg-[#041447] border border-blue-400/30 transition-colors duration-150 flex items-center justify-center gap-2"
            >
